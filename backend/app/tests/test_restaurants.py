...
def db_session():
    ...
    db.add_all([
        ...
        Restaurant(name="Bella Napoli",     cuisine="italienne",  city="Lyon",     price_range=2, rating=4.2),
        Restaurant(name="Dragon Palace",    cuisine="chinoise",   city="Paris",    price_range=1, rating=3.7),
        Restaurant(name="Tacos del Sur",    cuisine="mexicaine",  city="Bordeaux", price_range=1, rating=3.9),
