...
def seed():
    ...
    restaurants = [
        ...
        Restaurant(name="La Bouillabaisse",    cuisine="méditerranéenne", city="Marseille", price_range=3, rating=4.7),
        ...
        Restaurant(name="L'Atelier Tapas",     cuisine="espagnole",       city="Bordeaux",  price_range=2, rating=4.3),
        ...
        Restaurant(name="Blue Mediterranean",  cuisine="méditerranéenne", city="Nice",      price_range=3, rating=4.4),
    ]
