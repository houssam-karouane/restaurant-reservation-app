...
def seed():
    ...
    restaurants = [
        Restaurant(
            name="Le Petit Bistrot", cuisine="française", city="Paris", price_range=2, rating=4.5
        ),
        Restaurant(
            name="Sakura Tokyo", cuisine="japonaise", city="Paris", price_range=3, rating=4.8
        ),
        Restaurant(
            name="Bella Napoli", cuisine="italienne", city="Paris", price_range=2, rating=4.2
        ),
        Restaurant(
            name="Le Grand Luxe", cuisine="française", city="Paris", price_range=4, rating=4.9
        ),
        Restaurant(
            name="Tacos del Sur", cuisine="mexicaine", city="Paris", price_range=1, rating=3.9
        ),
        Restaurant(
            name="Dragon Palace", cuisine="chinoise", city="Paris", price_range=2, rating=3.7
        ),
        Restaurant(
        ...
        Restaurant(
            name="La Trattoria", cuisine="italienne", city="Lyon", price_range=3, rating=4.4
        ),
        Restaurant(
        ...
        Restaurant(
            name="Spice Garden", cuisine="indienne", city="Marseille", price_range=2, rating=3.8
        ),
        Restaurant(
            name="Château Table", cuisine="française", city="Bordeaux", price_range=4, rating=4.8
        ),
        Restaurant(
            name="L'Atelier Tapas", cuisine="espagnole", city="Bordeaux", price_range=2, rating=4.3
        ),
        Restaurant(
            name="Burger & Co", cuisine="américaine", city="Bordeaux", price_range=1, rating=3.5
        ),
